						...
						<div class="card-body p-0">
							<table class="table table-striped">
								...
								<tbody>
									...
									while($slider_getir = $slidersorgu->fetch(PDO::FETCH_ASSOC)){

									 ?>

									 <tr>
									 	<td><?php echo $slider_getir['id']; ?></td>
									 	<td><?php echo $slider_getir['resim']; ?></td>
									<td>
												<a href="slider-duzenle.php?id=<?php echo $slider_getir['id']; ?>"><button class="btn btn-success" type="submit">DÜZENLE</button></a>
												<a href="slider.php?islem=sil&id=<?php echo $slider_getir['id']; ?>"><button class="btn btn-danger" type="submit">SİL</button></a>
											</td>
...
if(isset($_GET['islem']) AND $_GET['islem'] == "sil"){
	...
	if(!empty($_GET['id'])){
		...
		$delete = $db->prepare("DELETE FROM slider WHERE id=:id");
